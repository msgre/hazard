...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('geo_entry', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.description'
        db.delete_column('geo_entry', 'description')
