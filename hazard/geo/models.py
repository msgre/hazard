...
class Entry(models.Model):
    ...
    population      = models.IntegerField(u"Populace", blank=True, null=True, help_text=u"Zadej celé číslo (např. pro Brno to může být 403379).")
    area            = models.IntegerField(u"Plocha katastrálního území", blank=True, null=True, help_text=u"Zadej celé číslo v km čtverečních (např. pro Brno to je cca 230).")
