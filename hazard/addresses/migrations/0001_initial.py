...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AltAddress'
        db.create_table('addresses_altaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('town', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['addresses.Address'])),
        ))
        db.send_create_signal('addresses', ['AltAddress'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AltAddress'
        db.delete_table('addresses_altaddress')
    ...
    models = {
        ...
        'addresses.altaddress': {
            'Meta': {'ordering': "('title',)", 'object_name': 'AltAddress'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'town': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['addresses.Address']"})
        },
