...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mf_building', 'surround', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('mf_building', 'surround')
