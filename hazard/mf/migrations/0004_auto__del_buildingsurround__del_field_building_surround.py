...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Building.surround'
        db.delete_column('mf_building', 'surround_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Building.surround'
        db.add_column('mf_building', 'surround', self.gf('django.db.models.fields.related.ForeignKey')(related_name='buildings_surrounds', null=True, to=orm['mf.BuildingSurround'], blank=True), keep_default=False)
