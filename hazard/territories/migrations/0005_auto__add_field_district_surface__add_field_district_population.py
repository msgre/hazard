...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'District.surface'
        db.add_column('territories_district', 'surface', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'District.population'
        db.add_column('territories_district', 'population', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'District.surface'
        db.delete_column('territories_district', 'surface')

        # Deleting field 'District.population'
        db.delete_column('territories_district', 'population')
