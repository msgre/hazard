...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Region.lokativ'
        db.add_column('territories_region', 'lokativ', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Region.lokativ'
        db.delete_column('territories_region', 'lokativ')
