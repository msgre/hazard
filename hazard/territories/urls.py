...
urlpatterns = patterns('',
    ...
    url(r'^(?P<region>[-0-9a-z]+)/kampan/(?P<type>mf)/', include('hazard.mf.urls_region')),
    url(r'^(?P<region>[-0-9a-z]+)/(?P<district>[-0-9a-z]+)/kampan/(?P<type>mf)/', include('hazard.mf.urls_district')),
    url(r'^(?P<region>[-0-9a-z]+)/(?P<district>[-0-9a-z]+)/(?P<town>[-0-9a-z]+)/kampan/(?P<type>mf)/', include('hazard.mf.urls_town')),
